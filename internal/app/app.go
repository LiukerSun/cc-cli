...
func printHelp(w io.Writer) {
	...
	fmt.Fprintln(w, "  ccc profile add [--name ...] [--preset anthropic|openai|zhipu|alibaba|kimi|deepseek] --api-key ...")
	fmt.Fprintln(w, "  ccc profile update <profile-id-or-name> [--preset anthropic|openai|zhipu|alibaba|kimi|deepseek] [--model ...]")
