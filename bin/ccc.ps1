...
function Show-Help {
    ...
    Write-Host "  ccc -v           Validate and repair config"
    Write-Host "  ccc -U           Upgrade to latest version"
}

function Show-Version {
    Write-Host "ccc version $CC_VERSION"
}
...
function Upgrade-CC {
    ...
    try {
        ...
        Write-Host ""
        Write-Host "Run 'ccc -V' to verify the upgrade"
...
function Show-Keys {
    ...
    Write-Host "-----------------------------------"
    Write-Host ""
    Write-Host "To edit keys: ccc -E"
    Write-Host "To add model: ccc -a"
}
...
function Validate-Config {
    ...
    try {
        ...
        Write-Host ""
        Write-Host "Please fix manually: ccc -E"
        exit 1
    }
